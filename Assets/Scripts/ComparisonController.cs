...
public class ComparisonController : MonoBehaviour
{
    ...
    private string GenerateComparisonDescription(string scenario)
    {
        ...
        {
            case "LightRainfall":
                return "Under light rainfall conditions, all farms show low phosphorus accumulation with negligible overflow. Reuse systems effectively retain phosphorus.";
